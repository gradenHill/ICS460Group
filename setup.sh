...
## Print instructions
TARGET_UI="history -s 'snort -A console -q -U -c ./snort.conf -i veth-target'; history -s 'tcpdump -i veth-target -w capture.pcap &'; clear && \
...
printf '\\033[1;32msnort -A console -q -U -c ./snort.conf -i veth-target\\033[0m\\n\\n' && \
