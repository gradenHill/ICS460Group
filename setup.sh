...
## Print instructions
TARGET_UI="history -s 'stdbuf -oL snort -A console -q -U -c ./snort.conf -i veth-target | tee alert'; history -s 'tcpdump -i veth-target -w capture.pcap &'; clear && \
...
printf '\\033[1;32mstdbuf -oL snort -A console -q -U -c ./snort.conf -i veth-target | tee alert\\033[0m\\n\\n' && \
