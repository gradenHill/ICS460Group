...
tmux send-keys -t NIDS:0.1 " history -s 'tcpdump -i veth-target -w capture.pcap'; history -s 'snort -A console -q -c ./snort.conf -i veth-target -k none'; clear && printf '=== TARGET SPACE (10.0.0.10) ===\\n\\n' && printf 'HINT: Press \\033[1;33mUP ARROW\\033[0m to cycle through commands:\\n\\n' && printf '1. Start Snort:\\n\\033[1;32msnort -A console -q -c ./snort.conf -i veth-target -k none\\033[0m\\n\\n' && printf '2. Capture PCAP:\\n\\033[1;32mtcpdump -i veth-target -w capture.pcap\\033[0m\\n' && echo" C-m
